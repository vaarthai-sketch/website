...
export const ministriesData: Ministry[] = [
  {
    ...
    englishPurpose: "At Varthai Church, we provide a safe, welcoming, and joyful environment for children aged 4 to 12 years.",
    audience: "Children aged 4 to 12 years (4 முதல் 12 வயது சிறுவர்கள்)",
    englishAudience: "Children aged 4 to 12 years",
    ...
    englishDescription: "At Varthai Church, we provide a safe, welcoming, and joyful environment for children aged 4 to 12 years. Our Kids Ministry is dedicated to helping children grow in their faith in Christ and develop a personal love for Jesus by enjoying the Word through age-appropriate Bible teaching, creative arts and crafts, worship, engaging games, and fun-filled activities.",
    features: [
  ...
  },
  {
    ...
    englishPurpose: "Helping young people grow in Christ and build positive, lasting godly friendships.",
    audience: "7 முதல் 12-ம் வகுப்பு வரையிலான மாணவர்கள்",
    englishAudience: "Students from Grades 7 to 12",
    ...
    englishDescription: "A dynamic and engaging platform where teens can ask questions and stand boldly in their faith. Through exciting games, relevant messages, and small group discussions, students discover biblical truths applicable to modern life.",
    features: [
    ...
    englishFeatures: [
      "Biblical discussions tailored for the younger generation",
      "Personal mentorship and guidance life groups",
      "Monthly social gatherings and community outreach projects",
      "Exciting summer camps and weekend retreats"
    ]
  },
  {
    id: "young-adults",

...
export const getEventsData = (): ChurchEvent[] => [
  ...
  },
  {
    ...
    time: "ஒவ்வொரு மாதமும் 4-வது ஞாயிறு (ஞாயிறு ஆராதனை முடிந்த உடனே)",
    englishTime: "The 4th Sunday of each month (Immediately following the Sunday Service)",

...
export const metadata = buildMetadata({
  locale: "ta",
  title: "VEC-NL 2026-09 Edition 10 - போதகர் மேசையிலிருந்து",
...
<p>ஒருகாலத்தில் விண்வெளி மனிதனுடைய ஆச்சரியம், அறிவியல் ஆராய்ச்சி மற்றும் புதிய கண்டுபிடிப்புகளின் அடையாளமாக இருந்தது. இன்று அது பாதுகாப்பு, அதிகாரம் மற்றும் ஆயுதப் போட்டியைப் பற்றிய உரையாடலின் ஒரு பகுதியாக மாறியிருக்கிறது.</p>

<p className="font-bold text-stone-900 text-lg">மனிதன் வானங்களை எட்டிவிட்டான்; ஆனால் மனித இதயம் இன்னும் சமாதானத்தை அடையவில்லையா?</p>

<p>“வானங்கள் தேவனுடைய மகிமையை வெளிப்படுத்துகிறது; ஆகாயவிரிவு அவருடைய கரங்களின் கிரியையை அறிவிக்கிறது” என்று சங்கீதம் 19:1 கூறுகிறது. தாவீது வானங்களைப் பார்த்தபோது, தேவனுடைய மகிமையைக் கண்டார். ஆனால் மனிதன் அதே வானங்களைப் பார்க்கும்போது, அங்கே தனது அதிகாரத்தை எவ்வாறு நிலைநாட்டலாம் என்றும், எதிரிகளிடமிருந்து எவ்வாறு தன்னைப் பாதுகாத்துக்கொள்ளலாம் என்றும் சிந்திக்கத் தொடங்கியிருக்கிறான்.</p>

<p>தேவன் தமது மகிமையை வெளிப்படுத்திய இடத்திற்குக்கூட மனிதன் தனது பயத்தையும் பகையையும் எடுத்துச் செல்கிறான். வானங்கள் மாறவில்லை; மனித இதயம்தான் மாற வேண்டியுள்ளது.</p>

<p>மனிதகுலம் அறிவியலிலும் தொழில்நுட்பத்திலும் நம்பமுடியாத அளவிற்கு முன்னேறியுள்ளது. ஆனால் அறிவியல் வளர்ச்சி நமது சுயநலம், பெருமை, பயம் மற்றும் அதிகார ஆசையைத் தானாக மாற்றிவிடுவதில்லை.</p>

<p>“உங்களுக்குள்ளே யுத்தங்களும் சண்டைகளும் எதினாலே வருகிறது? உங்கள் அவயவங்களில் போர்செய்கிற இச்சைகளினாலல்லவா?” என்று யாக்கோபு 4:1 கேட்கிறது. வேதாகமம் யுத்தத்தை தேசங்களுக்கிடையிலான ஒரு பிரச்சினையாக மட்டும் பார்க்கவில்லை; அதன் வேர்கள் மனித இதயத்திற்குள்ளும் இருப்பதாகக் காண்பிக்கிறது.</p>

<p>தொழில்நுட்பம், அதை இயக்குகிற மனிதனுடைய இதயத்தில் இருப்பதையே பெரிதாக்குகிறது. அன்புள்ள இதயத்தில் அது உயிர்களைக் காப்பாற்றும். பயமும் பகையும் நிறைந்த இதயத்தில் அதே தொழில்நுட்பம் அழிவின் கருவியாக மாறக்கூடும்.</p>

<p className="font-bold text-stone-900 text-lg">புதிய தொழில்நுட்பம் மனிதனுக்குப் புதிய திறன்களைக் கொடுக்கலாம்; ஆனால் புதிய இருதயத்தைத் தர இயேசு கிறிஸ்துவால் மட்டுமே முடியும்.</p>

<p>அதிகமான வல்லமையும் பாதுகாப்பும் இருந்தால் சமாதானம் கிடைக்கும் என்று உலகம் நம்புகிறது. தேசங்களுக்குப் பாதுகாப்பு தேவை என்பதையும், தலைவர்கள் சிக்கலான முடிவுகளை எடுக்க வேண்டியிருக்கிறது என்பதையும் நாம் மறுப்பதில்லை. ஆனால் ஆயுதங்கள் சில தாக்குதல்களைத் தடுக்கலாம்; மனித இதயத்திலுள்ள பகையை அவைகளால் அகற்ற முடியாது.</p>

<p>அதனால்தான் இயேசு,</p>
...
<p>இயேசு தரும் சமாதானம் எந்தப் பிரச்சினையும் இல்லாத வாழ்க்கை என்று பொருளல்ல. அது தேவனுடன் ஒப்புரவாக்கப்பட்ட உறவிலிருந்து பிறக்கும் சமாதானம். அது நமது பயத்தை ஆளுகிறது, கோபத்தைத் தணிக்கிறது, பகையை மன்னிப்பாக மாற்றுகிறது. அதனால்தான் எபேசியர் 2:14, “அவரே நம்முடைய சமாதானமாயிருக்கிறார்” என்று கூறுகிறது.</p>

<p className="font-bold text-stone-900 text-lg">சமாதானம் என்பது ஒரு கொள்கை மட்டுமல்ல; அது ஒரு நபர்—இயேசு கிறிஸ்து.</p>

<p>தேவனுடைய ராஜ்யத்தின் எதிர்காலத்தைப் பற்றி ஏசாயா ஒரு அழகான காட்சியைத் தருகிறார்:</p>
...
<p>பட்டயம் மண்வெட்டியாக மாறுகிறது. அழிப்பதற்குப் பயன்படுத்தப்பட்டது, வளர்ப்பதற்குப் பயன்படுத்தப்படுகிறது. மரணத்தை ஏற்படுத்திய கருவி, உயிரை வளர்க்கும் கருவியாக மாறுகிறது. இதுதான் கிறிஸ்துவின் ராஜ்யம் கொண்டுவரும் மாற்றம்.</p>

<p>விண்வெளியில் தேசங்கள் என்ன செய்கின்றன என்பதை நம்மால் தீர்மானிக்க முடியாது. ஆனால் நமது வீட்டிலும், சபையிலும், உறவுகளிலும் சமாதானத்தை வளர்ப்பதற்கு நாம் தீர்மானிக்க முடியும்.</p>

<p>“சமாதானம்பண்ணுகிறவர்கள் பாக்கியவான்கள்” என்று இயேசு கூறினார் (மத்தேயு 5:9). சமாதானம் செய்கிறவர்கள் பிரச்சினைகளைத் தவிர்ப்பவர்கள் அல்ல. அவர்கள் உண்மையை அன்புடன் பேசுகிறார்கள்; மன்னிக்க முன்வருகிறார்கள்; உடைந்த உறவுகளைச் சரிசெய்ய முயலுகிறார்கள்.</p>

<p>எனவே, தேசங்களுக்கிடையே சமாதானம் வேண்டும் என்று ஜெபிப்பதற்கு முன்பு, நம்மையே ஒரு கேள்வி கேட்டுக்கொள்வோம்:</p>
...
<p>ஒருவரை அழைக்க வேண்டுமா? மன்னிப்புக் கேட்க வேண்டுமா? நீண்ட நாட்களாக வைத்திருக்கும் கோபத்தை விட்டுவிட வேண்டுமா? உடைந்துபோன உறவைச் சரிசெய்ய முதல் அடியை எடுக்க வேண்டுமா?</p>

<p>மனிதன் வானங்களை எட்டிவிட்டான்; ஆனால் சமாதானத்திற்கான வழியை இன்னும் தேடிக்கொண்டிருக்கிறான். இயேசு அந்த வழியை நமக்குக் காண்பித்தவர் மட்டுமல்ல—அவரே நமது சமாதானமாக வந்தார்.</p>

<p>உலகம் விண்வெளியில் ஆயுதங்களை வைக்கும்போது, சபை பூமியில் சமாதானத்தின் விதைகளை விதைக்கட்டும்.</p>
...
<p>சமாதானத்தின் தேவனே, வானங்களும் பூமியும் உம்முடையவை. உலகத் தலைவர்களுக்கு ஞானத்தையும் பொறுப்புணர்வையும் தாரும். யுத்தங்களாலும் அச்சுறுத்தல்களாலும் பாதிக்கப்பட்ட மக்களைப் பாதுகாத்தருளும்.</p>

<p>ஆண்டவராகிய இயேசுவே, நீரே எங்கள் சமாதானம். எங்கள் இதயங்களிலுள்ள பெருமை, கோபம், பயம் மற்றும் பகையை அகற்றும். எங்களைச் சமாதானத்தைப் பேசுகிறவர்களாக மட்டுமல்லாமல், சமாதானத்தை உருவாக்குகிறவர்களாகவும் மாற்றும்.</p>

<p>எங்கள் வீடுகளிலும், சபையிலும், சமுதாயத்திலும் உமது சமாதானத்தை விதைக்க எங்களைப் பயன்படுத்தும். எங்கள் நம்பிக்கை மனித வல்லமையில் அல்ல; சமாதானப் பிரபுவாகிய உம்மிலேயே இருக்கச் செய்யும்.</p>
          ...
          <aside className="lg:w-1/3 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
              ...
              <div className="space-y-3">
                  ...
                  <Link href="/pastors-desk/archive/september/edition-10" className="group flex items-start gap-2 p-3 rounded-md bg-stone-50 border border-stone-200 hover:border-accent hover:bg-accent/5 transition-colors">

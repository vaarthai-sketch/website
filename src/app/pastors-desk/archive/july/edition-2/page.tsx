...
export const metadata = buildMetadata({
  locale: 'ta',
  path: '/pastors-desk/archive/july/edition-2',
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-sm border border-border p-6 sticky top-24">
                ...
                <div className="space-y-3">
                  ...
                  <Link href="/pastors-desk/archive/july/edition-2" className="group flex items-start gap-2 p-3 rounded-md bg-stone-50 border border-stone-200 hover:border-accent hover:bg-accent/5 transition-colors">

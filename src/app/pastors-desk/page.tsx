        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-border p-6 md:p-10 mb-8">
            ...
            <div className="prose prose-stone max-w-none text-stone-700 space-y-6 leading-relaxed text-base md:text-lg">
              ...
              <p>
                மிகவும் சிறப்பான மற்றும் வெற்றிகரமான தொடக்க ஆராதனையை நேற்றைய தினத்திலே நாம் பெற்றோம்! உங்கள் ஒவ்வொருவருக்கும் என் மனமார்ந்த வாழ்த்துகள்! இந்த புதிய தொடக்கமானது, இந்த சபையை ஒன்றிணைத்த விசுவாசம், அர்ப்பணிப்பு மற்றும் தொலைநோக்கு பார்வைக்கு ஒரு வலிமையான சான்றாகும்.
              </p>
              <p>

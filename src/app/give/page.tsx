          ...
          <div className="bg-[#F4F1E8] border border-[#E0DBCB] text-stone-900 rounded-2xl p-6 sm:p-8 shadow-md flex flex-col justify-between relative overflow-hidden h-full space-y-6">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-sm sm:text-base text-stone-700 leading-relaxed font-normal">
                உங்கள் தாராளமான முதற்பலன் காணிக்கைகள் வார்த்தை சுவிசேஷ திருச்சபையின் தொடர் ஊழியங்களுக்கும் மிஷனரி பணிகளுக்கும் பேருதவியாக உள்ளன. உங்கள் மன அமைதிக்காக அனைத்து ஆன்லைன் காணிக்கைகளும் 100% முழு பாதுகாப்போடு நிர்வகிக்கப்படுகின்றன. உங்கள் Credit/Debit Card, Apple Pay அல்லது Google Pay மூலம் மிக எளிதாகக் காணிக்கை செலுத்தலாம்.
              </p>
          ...
          <div className="bg-white border border-border p-6 sm:p-8 rounded-2xl shadow-sm flex flex-col justify-between h-full space-y-4">
            <div className="space-y-3">
              ...
              <div className="text-stone-700 leading-relaxed text-sm space-y-3">
                <p>Vaarthai Evangelical Church Inc என்பது குயின்ஸ்லாந்து மாநிலத்தில் பதிவு செய்யப்பட்ட கூட்டமைப்பு (பதிவு எண்: IA58572); ஆஸ்திரேலிய தர்ம நிறுவனங்கள் ஆணையத்தில் (ACNC) பதிவு பெற்ற தர்ம நிறுவனம். ABN 32 327 903 035.</p>

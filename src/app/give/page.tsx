        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="bg-white border border-border p-6 sm:p-8 rounded-2xl shadow-sm flex flex-col justify-between h-full space-y-4">
            <div className="space-y-3">
              ...
              <p className="text-stone-700 leading-relaxed text-sm">
                எங்கள் திருச்சபையின் நிதி மேலாண்மை முழுமையான வெளிப்படைத்தன்மையுடன் நிர்வாகக் குழு மற்றும் வெளிப்புற ஆடிட்டர்களால் கண்காணிக்கப்படுகிறது. வருடாந்திர நிதி அறிக்கைகள் சபை மக்களுக்கு சமர்ப்பிக்கப்படுகின்றன.
              </p>
            </div>
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mt-auto">
              <p className="text-xs text-emerald-800 leading-relaxed font-medium">
                ✓ வார்த்தை தமிழ் திருச்சபையானது, குயின்ஸ்லாந்தில் பதிவுசெய்யப்பட்ட (IA58572) வார்த்தை மினிஸ்ட்ரிஸ் இன்க். கீழ் செயல்படுகிறது. நாங்கள் ஆஸ்திரேலிய அறக்கட்டளைகள் மற்றும் இலாப நோக்கமற்ற ஆணையத்தில் (ACNC) பதிவுசெய்யப்பட்ட ஒரு தொண்டு நிறுவனமாகும். எங்கள் நிதியறிக்கைகள் ஆண்டுதோறும் சுயாதீனமாகத் தணிக்கை செய்யப்படுகின்றன.
              </p>
            </div>
          </div>

      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 space-y-3">
          ...
          <p className="text-stone-300 text-base md:text-lg max-w-xl mx-auto font-light leading-relaxed">
            Discover active fellowships, Bible study groups, and community outreach programs where you can connect and serve.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredMinistries.map((ministry) => (
            <MinistryCard key={ministry.id} ministry={ministry} basePrefix="/en" />
          ))}
        </div>
      </section>
        ...
        <div className="bg-[#0F172A] text-white p-8 sm:p-12 rounded-xl text-center space-y-4 relative overflow-hidden">
          ...
          <div className="space-y-2 max-w-2xl mx-auto relative z-10">
            ...
            <p className="text-sm text-stone-300 leading-relaxed font-light">
              We would love to help you find the right small group, volunteer team, or fellowship class. Contact our community connections team, and we will get right back to you!
            </p>
          </div>

          ...
          <aside className="lg:w-1/3 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6">
              ...
              <div className="space-y-3">
                  ...
                  <Link href="/en/pastors-desk/archive/september/edition-8" className="group flex items-start gap-2 p-3 rounded-md bg-stone-50 border border-stone-200 hover:border-accent hover:bg-accent/5 transition-colors">

    ...
    <div className="pb-20 space-y-12">
      ...
      <section className="bg-neutral-light/50 border-b border-border py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link 
            href={isEn ? "/en/sermons" : "/sermons"} 
            className="text-sm font-semibold text-primary hover:text-accent inline-flex items-center gap-1.5 transition-colors"
          >
            <ArrowLeft className="w-4 h-4" /> {isEn ? "Back to Sermon Library" : "செய்திகளின் தொகுப்பிற்குத் திரும்பு"}
          </Link>
        </div>
      </section>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="aspect-video w-full rounded-xl overflow-hidden bg-black shadow-lg relative flex items-center justify-center">
              <iframe
                ...
                title={isEn ? (sermon.englishTitle || sermon.title) : sermon.title}
                frameBorder="0"
            ...
            <div className="space-y-4">
              <span className="text-xs font-bold text-accent uppercase tracking-widest bg-accent/10 px-2.5 py-0.5 rounded border border-accent/20">
                {isEn ? (sermon.englishSeries || sermon.series) : sermon.series}
              </span>
          ...
          <div className="lg:col-span-4 bg-white border border-border p-6 rounded-xl shadow-sm space-y-6 self-start">
            ...
            <div className="space-y-4 text-sm text-stone-600">
              ...
              <div className="space-y-1">
                <span className="text-xs text-stone-400 font-bold uppercase tracking-wider block">{isEn ? "Speaker" : "போதகர்"}</span>
              ...
              <div className="space-y-1">
                <span className="text-xs text-stone-400 font-bold uppercase tracking-wider block">{isEn ? "Date Preached" : "தேதி"}</span>
                <div className="flex items-center gap-2 text-stone-900 font-medium">
              ...
              <div className="space-y-1">
                <span className="text-xs text-stone-400 font-bold uppercase tracking-wider block">{isEn ? "Primary Bible Verse" : "முக்கிய வேதப்பகுதி"}</span>
                <div className="flex items-center gap-2 text-stone-900 font-medium">
            ...
            <div className="border-t border-border pt-6 space-y-4">
              ...
              <p className="text-xs text-stone-500 leading-relaxed">
                This message was preached during the series <strong>"{isEn ? (sermon.englishSeries || sermon.series) : sermon.series}"</strong>, looking at foundational scripture passages.
              </p>
              <Link 
                href={isEn ? "/en/sermons" : "/sermons"} 

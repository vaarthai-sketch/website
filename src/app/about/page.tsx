      ...
      <section id="governance" className="bg-neutral-light/50 border-t border-border py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="text-stone-700 leading-relaxed text-sm md:text-base space-y-4 max-w-3xl mx-auto">
            ...
            <p>
              எங்கள் நிர்வாக ஆவணங்களின் நகல்கள் தேவைப்பட்டால் <a href="mailto:info@vaarthai.org.au" className="text-emerald-700 hover:underline">info@vaarthai.org.au</a> என்ற மின்னஞ்சலில் தொடர்பு கொள்ளலாம்.
            </p>
          </div>
        </div>
      </section>

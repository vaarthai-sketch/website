      ...
      <section className="bg-neutral-light/50 border-t border-border py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="text-stone-700 leading-relaxed text-sm md:text-base space-y-4 max-w-3xl mx-auto">
            <p>
              Vaarthai Evangelical Church Inc என்பது 1981 சங்கங்கள் ஒருங்கிணைப்புச் சட்டத்தின் (Qld) கீழ் குயின்ஸ்லாந்தில் பதிவுசெய்யப்பட்ட ஒரு கூட்டமைப்பு (பதிவு எண்: IA58572), மற்றும் ஆஸ்திரேலிய தர்ம நிறுவனங்கள் ஆணையத்தில் (ACNC) பதிவு பெற்ற தர்ம நிறுவனம். ABN 86 636 931 539.
            </p>
            <p>
